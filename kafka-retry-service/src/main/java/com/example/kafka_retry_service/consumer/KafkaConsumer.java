package com.example.kafka_retry_service.consumer;

import com.example.kafka_retry_service.publisher.KafkaPublisher;
...
public class KafkaConsumer {
    ...
    @KafkaListener(topics = {ORDER_CREATE_KAFKA_CONSUMER_ERROR}, groupId = GROUP_ID, containerFactory = "kafkaListenerContainerFactory")
